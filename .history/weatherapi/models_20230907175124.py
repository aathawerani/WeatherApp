...
class DRFPost(models.model):
    __monScreen : MonitoringScreen

    def __init__(self):
        weatherStation = WeatherStation()        
        self.__monScreen = MonitoringScreen(weatherStation)
...
class MonitoringScreen():
    ...
    __weatherComponent : WeatherStationComponent

    def __init__(self, weatherComponent: WeatherStationComponent):
        self.__weatherComponent = weatherComponent
...
class Nimbus1_0Toolkit(StationToolkit):
    def makeTemperature():
        pass
    def makePressure():
        pass