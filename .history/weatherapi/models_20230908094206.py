...
class WeatherStation(WeatherStationComponent):
    __stationToolkit : StationToolkit
    def __init__(self, stationToolkit: StationToolkit):
        self.__stationToolkit = stationToolkit
    def addBPObserver(self):
        return self.__stationToolkit.makeTemperature()
    def addTempObserver(self):
        return self.__stationToolkit.makePressure()
